# Take-home agent rules

## Mission

Build the Sezzle calculator take-home as a small, reliable local artifact. The
...
- Do not publish, upload, or submit the take-home. Local implementation only.
...
- `takehome-PRD.md` and `takehome-issues.md` in the parent application folder define the approved scope.
